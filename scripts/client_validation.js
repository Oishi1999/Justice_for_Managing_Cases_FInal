...
function registrationValidation(){
    ...
    var fullname=getElement("reg_fullname");
    var err_fullname=getElement("err_reg_fullname");
	
    var username=getElement("reg_username");
    var err_username=getElement("err_reg_username");
	
    var email=getElement("reg_email");
    var err_email=getElement("err_reg_email");
    
	var phone=getElement("reg_phone");
    var err_phone=getElement("err_reg_phone");
    
	var pass=getElement("reg_pass");
    var err_pass=getElement("err_reg_pass");
    
	var cpass=getElement("reg_cpass");
    var err_cpass=getElement("err_reg_cpass");
    
	var nid=getElement("reg_nid");
    var err_nid=getElement("err_reg_nid");
    
	var dob=getElement("reg_dob");
    var err_dob=getElement("err_reg_dob");
    
	var gender_male=getElement("gender_male");
    var gender_female=getElement("gender_female");
    var err_gender=getElement("err_reg_gender");
	
    var address=getElement("reg_address");
    var err_address=getElement("err_reg_address");
	
    var city=getElement("reg_city");
    var err_city=getElement("err_reg_city");
    
	var state=getElement("reg_state");
    var err_state=getElement("err_reg_state");
    
	var zip=getElement("reg_zip");
    var err_zip=getElement("err_reg_zip");
