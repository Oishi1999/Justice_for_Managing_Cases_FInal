<?php
require_once '../controllers/client_payment_bkash_controller.php';
...
<html>
    ...
    <body>
		...
		<form action="" method="POST" enctype="multipart/form-data" onsubmit="return registrationValidation()" style="padding:20px;">
                <table>
                    <tr>
                        <td style="padding:20px;"><img src="../assets/bikash.png"; width="380" height="480"></td>
                        <td align="center">
                                ...
                                <div class="card-body">
                                    <table>
										...
										<tr>
                                            ...
                                            <td align="left" style="padding-bottom:10px;"><input class="form-control" type="date" name="due_date" id="due_date" placeholder="due_date" value="<?php echo $due_date; ?>"><span id="err_due_date" style="color:red;"><?php echo $err_due_date;?></span></td>
                                        </tr>
										
										<tr>
                                            <td align="left" style="padding-bottom:10px;">Payment Date: </td>
                                            <td align="left" style="padding-bottom:10px;"><input class="form-control" type="date" name="payment_date" id="payment_date" placeholder="payment_date" value="<?php echo $payment_date; ?>"><span id="err_payment_date" style="color:red;"><?php echo $err_payment_date;?></span></td>
                                        </tr>
