<?php
require_once '../controllers/client_payment_cash_controller.php';
...
<html>
    ...
    <body>
		...
		<form action="" method="POST" enctype="multipart/form-data" onsubmit="return registrationValidation()" style="padding:20px;">
                <table>
                    <tr>
                        <td style="padding:20px;"><img src="../assets/cash.png"; width="380" height="480"></td>
                        <td align="center">
                            <div class="card border-success mb3 dropshadow">
                                <div class="card-header">Payment  Via Cash</div>
                                <div class="card-body">
                                    <table>
